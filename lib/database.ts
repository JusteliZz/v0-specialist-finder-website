...
// --- PREDEFINED SERVICES ---
export const individualServiceCategories = [
  "Konsultavimas",
  "Rašymas/Vertimas",
  "Programavimas/IT",
  ...
  "Vairavimas/Pristatymas",
  "Mokymas/Korepetavimas",
  "Dizainas/Kūryba",
  "Rinkodara/Socialinė žiniasklaida",
  "Teisinės paslaugos",
  "Asmeninis treniravimas",
  "Priežiūra/Remontas",
  "Muzika/Pramogos",
  "Kitos profesionalios paslaugos",
]
...
// Combined for backward compatibility and filtering
export const serviceCategories = [
  ...individualServiceCategories,
  ...businessServiceCategories.filter((cat) => !individualServiceCategories.includes(cat)),
]

export const individualPredefinedServices = {
  Konsultavimas: [],
  "Rašymas/Vertimas": [],
  "Programavimas/IT": [],
  "Apskaita/Buhalterija": [],
...
export const businessPredefinedServices = {
  Gamyba: ["Produktų gamyba", "Surinkimo paslaugos", "Pakavimo paslaugos", "Individuali gamyba", "Kokybės kontrolė"],
  "Mažmeninė prekyba": [
    "Didmeninė prekyba",
    "Atsargų valdymas",
    "Pardavimo sistemų diegimas",
    "Distribucijos paslaugos",
    "E. prekybos sprendimai",
  ],
  Statyba: [
    "Bendroji statyba",
    "Santechnikos darbai",
    "Staliaus darbai",
    "Renovacijos paslaugos",
    "Elektros darbai",
    "Šildymo ir vėdinimo sistemų įrengimas",
    "Dažymo darbai",
    "Projektų valdymas",
  ],
  Technologijos: [
  ...
  "Sveikatos priežiūra": [
    "Medicinos paslaugos",
    "Fizioterapija",
    "Sveikatos priežiūros konsultacijos",
    "Odontologijos paslaugos",
    "Psichikos sveikatos paslaugos",
    "Medicininės įrangos tiekimas",
  ],
  Švietimas: [
    "Mokymo programos",
    "Korepetitorių paslaugos",
    "E. mokymosi sprendimai",
    "Švietimo konsultacijos",
